...
\title[NITR style for Beamer]{
  NITR style for Beamer \LaTeX}
...
\author[Roshan P Koshy MTech]{
  Roshan P Koshy Mtech \\\medskip
  {\small \url{rospkos.07@gmail.com}}}

% The institute:
%  - to start the name of the university as displayed on the top of each slide
%    this can be adjusted such that you can also create a Dutch version
%  - next the institute information as displayed on the title slide
\institute[\specialcell{National Institute of Technology \\ Rourkela}]{
